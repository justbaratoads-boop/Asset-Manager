...
import { useListDebitNotes, useDeleteDebitNote } from "@workspace/api-client-react";
          ...
          <Card key={n.id}>
            <CardContent className="p-4 space-y-3">
              ...
              <div className="flex gap-2 border-t pt-3">
                <Link href={`/accounts/debit-notes/${n.id}`} className="flex-1">
                ...
                <TableRow key={n.id}>
                  ...
                  <TableCell>
                    <div className="flex gap-1">
                      <Link href={`/accounts/debit-notes/${n.id}`}><Button size="icon" variant="ghost" className="h-7 w-7" title="View"><Eye className="h-3.5 w-3.5" /></Button></Link>
