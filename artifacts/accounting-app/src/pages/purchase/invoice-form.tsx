  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      {item.gstInclusive ? "Inclusive" : "Exclusive"}
                      ...
                      <div className="space-y-1"><Label className="text-xs text-muted-foreground">GST%</Label><div className="h-10 flex items-center gap-1.5 px-2 bg-muted rounded-md border text-sm text-muted-foreground"><Lock className="h-3 w-3 shrink-0" />{item.gstPct}%</div></div>
